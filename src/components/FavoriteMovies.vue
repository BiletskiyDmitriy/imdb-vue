<template>
  <div class="seen-collection" data-collectionid="top-250">
    <div class="article">
      <h3>IMDb Charts</h3>
      <h1 class="header">Favorite Movies</h1>
      <hr>
      <div class="lister">
        <div>
          <div class="nav">
        ...
        <br class="clear">
        <table class="chart full-width" data-caller-name="chart-top250movie" v-if="favoriteMovies.length">
          <colgroup>
          ...
          <tbody class="lister-list">
            <movie v-for="(movie, key) in favoriteMovies"
                   :movie="movie"
                   :key="movie.imdbID"
                   :index="key + 1">
            </movie>
        ...
        <div v-else>
          <h2 class="loading">No favorite movies</h2>
        </div>
      </div>
      <hr>
